...
/// <summary>
///     Control parameter used by invoke injections that wrap a five-argument value-producing call,
///     or a five-parameter target method under whole-method Around.
/// </summary>
...
public sealed class Operation<T1, T2, T3, T4, T5, TResult> {
    /// <summary>
