...
/// <summary>
///     Control parameter used by invoke injections that wrap a seven-argument void call,
///     or a seven-parameter void target method under whole-method Around.
/// </summary>
...
public sealed class VoidOperation<T1, T2, T3, T4, T5, T6, T7> {
    /// <summary>
